...
//FIREBLADE
        ...
        // change anytime vars
        dmflags = gi.cvar ("dmflags", "16", CVAR_SERVERINFO);
        fraglimit = gi.cvar ("fraglimit", "60", CVAR_SERVERINFO);
        timelimit = gi.cvar ("timelimit", "60", CVAR_SERVERINFO);
...
//FIREBLADE
	...
	tkbanrounds = gi.cvar("tkbanrounds", "2", 0);
        ...
        actionversion = gi.cvar("actionversion", "1.52LTK", CVAR_SERVERINFO|CVAR_LATCH);
...
//ACEBOT ADD - RiEvEr
		ltk_skill = gi.cvar( "ltk_skill", "3", 0);
