...
//END FF ADD
                        ...
                        {
                                //if (IsNeutral(self))
					//safe_bprintf (PRINT_MEDIUM, "%s plummets to its death\n", self->client->pers.netname, message);
                                //else if (IsFemale(self))
					//safe_bprintf (PRINT_MEDIUM, "%s plummets to her death\n", self->client->pers.netname, message);
                                //else
					//safe_bprintf (PRINT_MEDIUM, "%s plummets to his death\n", self->client->pers.netname, message);
                ...
                if ( mod == MOD_BLEEDING )              
                {
			safe_bprintf (PRINT_MEDIUM, "%s bleeds to death\n", self->client->pers.netname, message);
                        return; 
                }
#endif
